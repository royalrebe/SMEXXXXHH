...
def long_key():
  ...
  pos = requests.post(url="https://api.stripe.com/v1/tokens", headers={'Content-Type': 'application/x-www-form-urlencoded'}, data={'card[number]': '6011003187407125','card[cvc]': '852','card[exp_month]': '11','card[exp_year]': '2023'}, auth=(skkey, ""))
